	...
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
				<s:a action="forumAction_show?id=%{id}">${forum.name}</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				发表新主题
			</div>
		</div>
				...
				<tr>
					...
					<td class="InputAreaBg"><div class="InputContent">
						...
						<table cellpadding="0" border="0" cellspacing="0">
							...
							<tr>
							  <s:iterator begin="1" end="14" var="p">
								<td width="50" style="border-bottom:0 solid #ffffff">
									<input type="radio" name="faceIcon" value="${ p}" id="r_${ p}"/>
									<label for="r_${p}"><img width="19" height="19" src="${pageContext.request.contextPath}/style/images/face/face${ p}.gif" align="absmiddle" disabled="true"/></label>
								</td>
							  </s:iterator>
							</tr>
						</table></div>
