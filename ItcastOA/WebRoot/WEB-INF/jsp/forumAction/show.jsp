...
<div id="MainArea">
	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<font class="MenuPoint"> &gt; </font>
			${forum.name}
			<span style="margin-left:30px;"><s:a action="topicAction_addUI?forumId=%{#forum.id}">
					...
					<tr height="35" id="d0" class="template">
						...
						<td class="ForumTopicPageDataLine">
							<ul class="ForumPageTopicUl">
								...
								<li class="CreateTime"><s:date name="%{createTime}" format="yyyy-MM-dd HH:mm:ss"/> </li>
							</ul>
						</td>
						...
						<td class="ForumTopicPageDataLine">
							<ul class="ForumPageTopicUl">
								...
								<li class="CreateTime"><s:date name="%{lastReply.createTime}" format="yyyy-MM-dd HH:mm:ss"/></li>
							</ul>
						</td>
						<td></td>
					</tr>
